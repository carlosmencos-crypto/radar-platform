create or replace function public.radar_authorized_voter_communities(
...
as $$
  with authorized as (
    ...
    from public.radar_authorized_context_v2(
      'municipality',
      p_municipality_code
    )
    limit 1
...
revoke all on function public.radar_authorized_voter_communities(text) from anon;
