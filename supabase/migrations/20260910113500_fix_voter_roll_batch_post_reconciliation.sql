...
begin
  ...
  from (
    ...
    from (
      select distinct municipality_code,source_year
      from private.stg_voter_roll_community_aggregates
    ...
    where t.target_rows <> a.community_count
       or t.electors <> a.elector_count
       or t.a18 <> a.age_18_29
       or t.a30 <> a.age_30_44
       or t.a45 <> a.age_45_59
       or t.a60 <> a.age_60_plus
       or t.amiss <> a.age_missing_count
  ) q;
  if v_bad_count <> 0 then
