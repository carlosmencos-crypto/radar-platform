...
test("V70 gate loads client-ready authorized runtime v8 while retaining point bundle on demand", () => {
  ...
  assert.match(loader, /client_readiness/);
  assert.match(loader, /missing_requirements/);
