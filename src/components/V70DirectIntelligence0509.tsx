...
export function V70DirectIntelligence0509() {
  ...
  return <MunicipalityProvider consumer={consumer}><V70DirectShell0509 active="inteligencia" eyebrow="EXPEDIENTE MUNICIPAL 360" topbarTitle="San José / Puerto San José" accountRole="Cuenta del municipio" dayDNext intelligenceExportSelection={exportSelection}><IntelligenceContent onSelectionChange={handleSelectionChange} /></V70DirectShell0509></MunicipalityProvider>;
}
