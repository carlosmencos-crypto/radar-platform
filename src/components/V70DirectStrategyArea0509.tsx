...
const legalSlate = [
  ["EC01", "Nombre Apellido", "Candidato a alcalde"], ["EC02", "Nombre Apellido", "Síndico I"],
  ["EC03", "Nombre Apellido", "Síndico II"], ["EC04", "Nombre Apellido", "Síndico III"],
  ["EC05", "Nombre Apellido", "Concejal I"], ["EC06", "Nombre Apellido", "Concejal II"],
  ["EC07", "Nombre Apellido", "Concejal III"], ["EC08", "Nombre Apellido", "Concejal IV"],
  ["EC09", "Nombre Apellido", "Concejal V"], ["EC10", "Nombre Apellido", "Concejal VI"],
  ["EC11", "Nombre Apellido", "Concejal VII"], ["EC12", "Nombre Apellido", "Concejal VIII"],
] as const;
...
function RecordsWorkspace({ config }: { config: (typeof areaConfig)[keyof typeof areaConfig] }) {
  ...
  const candidate = legalSlate.find(([code]) => code === candidateCode);
  const [open, setOpen] = useState(false);
  const [saving, setSaving] = useState(false);
