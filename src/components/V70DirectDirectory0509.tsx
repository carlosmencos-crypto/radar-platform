        ...
        <div className="agenda-modal elector-modal" role="dialog" aria-modal="true">
          <section className="elector-sheet">
            ...
            <form className="elector-private-form" onSubmit={saveProfile}>
              ...
              <div className="agenda-form-grid">
                <div className="wide photo-editor-field"><span>Fotografía</span><V70PhotoEditor allowRemove currentSrc={profile.photo_url} onChange={(photo_url) => setProfile((current) => ({ ...current, photo_url }))} onError={setMessage} /></div>
